...
export default function EditRoot() {
  ...
  return (
    <section className='px-2 md:px-4 flex-1 max-w-[1500px] mx-auto'>
      <h1 className='font-poppins text-3xl sm:text-4xl lg:text-5xl 2xl:text-6xl text-center lg:text-left my-4 lg:my-8  font-semibold text-mainBlue'>
      ...
      <article className='my-8 grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4'>
        ...
        <Link to='personal_info' className='edit_link'>
          ...
          <p>
            At a minimum, your contact information section should include your
            name, phone number and email address. Depending on the type of job
            you’re applying for, you might also include a link to an online
