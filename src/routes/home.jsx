...
export default function Home() {
  ...
  return (
    <main>
      <header className='bg-mainBlue flex justify-between items-center px-2 py-2'>
        <h2 className='font-roboto font-semibold text-2xl text-white'>
          Resume Builder
        </h2>
        <button
  ...
  return (
    ...
    >
      <div className='flex justify-between'>
        <h3 className='text-2xl font-roboto font-semibold text-darkBlue bg-white'>
          Resume builder
        </h3>
        <button
